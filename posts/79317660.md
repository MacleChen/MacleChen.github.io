...
UIImage \*image\_ = [self imageWithScreenshot];

//添加显示

UIImageView \*imgvPhoto = [[UIImageView alloc]initWithImage:image\_];
...
CGContextRotateCTM(context, M\_PI\_2);
...
CGContextRotateCTM(context, M\_PI);
