![image.png](images/posts/da7a324e0d61.png)

1. 创建项目时选择
   ![image.png](images/posts/05b8f8323f68.png)
2. 创建实体（选择项目中的.xcdatamodeld后缀文件）
   ![image.png](images/posts/8c86ac2d11ae.png)
3. 创建实体类
   ![image.png](images/posts/bfe301d387a4.png)
